...
Rectangle rectangle_union (Rectangle const& r1, Rectangle const& r2) {
  Point lowerLeft (min(r1.getX0(), r2.getX0()), min(r1.getY0(), r2.getY0()));
  Point upperRight (max(r1.getX1(), r2.getX1()), max(r1.getY1(), r2.getY1()));
  return Rectangle(lowerLeft, upperRight);
}

Rectangle rectangle_intersection (Rectangle const& r1, Rectangle const& r2) {
  Point lowerLeft (max(r1.getX0(), r2.getX0()), max(r1.getY0(), r2.getY0()));
  Point upperRight (min(r1.getX1(), r2.getX1()), min(r1.getY1(), r2.getY1()));
  return Rectangle(lowerLeft, upperRight);
}
